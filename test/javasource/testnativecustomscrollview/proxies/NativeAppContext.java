...
public class NativeAppContext
{
	...
	public static testnativecustomscrollview.proxies.NativeAppContext initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return testnativecustomscrollview.proxies.NativeAppContext.load(context, mendixIdentifier);
	}
